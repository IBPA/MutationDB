...
{
df=read.csv(paste("../David/cluster",i,".csv",sep=""),header=TRUE,stringsAsFactors = FALSE) 
...
write.csv(GO_p_value,"../out_data/GO_p_values.csv")
write.csv(GO,"../out_data/GO.csv")
...
pdf("filename.pdf", height=5, width=13)
